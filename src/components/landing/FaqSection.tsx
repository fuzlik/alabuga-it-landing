...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Да. Кандидатам, прошедшим предварительный отбор, мы компенсируем проезд до Елабуги на очный этап. Условия и порядок компенсации сообщаем вместе с приглашением.",
  },
  {
    id: "salary",
    question: (
  ...
  },
  {
    ...
    answer:
      "Итоговую оценку подводим в конце программы. Участники, успешно прошедшие все этапы, получают приглашение в команду в течение нескольких недель после завершения.",
  },
  {
    id: "simulation",
    accent: true,
